...
/*
      ...
      Serial.print("value: ");
*/
      //0x03 - Read Holding Registers (channel:"1", type:i ,value:3)
      if (channel == 1 && values[0] == 3) {
            //ToDo  Tx Queue
            requestFlg = 1;
      }
    } else {
  ...
  case 2:
    ...
    if (master.getState() == COM_IDLE) {
      ...
      if(countSendFlg >= 80){
        sakuraio.clearTx();
        sakuraio.enqueueTx(0,(int32_t)au16data1[0]);
        sakuraio.enqueueTx(1,(int32_t)au16data1[1]);
        sakuraio.enqueueTx(2,(int32_t)au16data1[2]);
        sakuraio.enqueueTx(3,(int32_t)au16data1[3]);
        sakuraio.enqueueTx(4,(int32_t)au16data1[4]);
        sakuraio.enqueueTx(5,(int32_t)au16data1[5]);
        sakuraio.send();
        countSendFlg = 0;
      }
      countSendFlg++;
...
/*
  ...
  /*
    if(requestFlg == 1){
      ...
      sakuraio.enqueueTx(3,(uint32_t)au16data1[3]);
      sakuraio.enqueueTx(4,(uint32_t)au16data1[4]);
      sakuraio.enqueueTx(5,(uint32_t)au16data1[5]);
      sakuraio.send();
      //Serial.print("Send ");
      //Serial.println(ret);
      requestFlg = 0;
...
/*
    if(countSendFlg >= 20){
      sakuraio.clearTx();
      sakuraio.enqueueTx(0,(int32_t)au16data1[11]);
      sakuraio.enqueueTx(1,(int32_t)au16data1[12]);
      sakuraio.enqueueTx(2,(int32_t)au16data1[13]);
      sakuraio.enqueueTx(3,(int32_t)au16data1[14]);
      sakuraio.enqueueTx(4,(int32_t)au16data1[15]);
      sakuraio.enqueueTx(5,(int32_t)au16data1[16]);
      sakuraio.send();
      //Serial.print("Send ");
      //Serial.println(ret);
      countSendFlg = 0;
